...
<table>
  ...
  <tr><td><strong>Fill in song details</strong></td><td>Works in two steps. First Cue shows <strong>what the song has now</strong> — Title, Artist, Key, Tempo, Duration and YouTube, with blanks marked <em>empty</em> — and each has a <strong>tick box</strong>, all ticked to begin with. Untick anything you'd rather keep as it is (a YouTube link you'll choose yourself, say) and Cue looks up <em>only</em> what's ticked. Then it shows what it found: apply the whole lot, or each row on its own. Nothing changes until you apply it. Key is read from the chords; Tempo, Duration and the video are web-searched best guesses about the well-known recording, so check them.</td></tr>
