...
<p><strong>Try again — smarter</strong>, which appears beside an answer that looks off, re-runs that <em>one</em> answer a step above your setting. On <strong>Best</strong> there is nothing above it, so the link doesn't appear at all rather than charging you twice for the same answer. A cheaper tier is planned for when Cue can offer a genuinely free one.</p>
