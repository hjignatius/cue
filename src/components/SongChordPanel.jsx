                ...
                <div key={idx} className="relative group/s">
                  ...
                  {!readonly && (
                    <button
                      ...
                      className={`absolute -top-1 -right-1 w-4 h-4 rounded-full border flex items-center justify-center opacity-0 group-hover/s:opacity-100 pointer-coarse:opacity-100 transition-opacity ${dark ? 'bg-gray-800 border-gray-700 text-gray-500 hover:text-red-400' : 'bg-white border-gray-300 text-gray-400 hover:text-red-500'}`}
