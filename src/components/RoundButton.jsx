// Shared round control used by the Present floating panel and the chord panel's
// size strip. Owns the fill palette so neither consumer has to depend on the
// other (SongChordPanel/PresentationView must not import from PresentControls,
// which is Present-only).

// The reference value is the Night one: a translucent grey circle reads well
// against a dark background. Day inverts to a darker fill so the white glyph
// keeps its contrast against a light page.
